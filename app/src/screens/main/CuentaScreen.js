...
const styles = StyleSheet.create({
  ...
  primaryBtn: { backgroundColor: '#FF8C40', borderRadius: 14, paddingVertical: 16, alignItems: 'center', elevation: 4, marginBottom: 10 },
  primaryBtnDisabled: { backgroundColor: '#9CA3AF', elevation: 0 },
  primaryBtnText: { color: '#FFF', fontSize: 16, fontWeight: '800' },
  secondaryBtn: { borderWidth: 2, borderColor: '#FF8C40', borderRadius: 14, paddingVertical: 14, alignItems: 'center', marginBottom: 10 },
  secondaryBtnText: { color: '#FF8C40', fontSize: 15, fontWeight: '700' },
  ...
  switchBtnText: { color: '#FF8C40', fontSize: 14, fontWeight: '600' },
  profileCard: { backgroundColor: '#FFF', borderRadius: 16, padding: 24, alignItems: 'center', marginBottom: 20, elevation: 2 },
  avatarCircle: { width: 64, height: 64, borderRadius: 32, backgroundColor: '#FF8C40', alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
